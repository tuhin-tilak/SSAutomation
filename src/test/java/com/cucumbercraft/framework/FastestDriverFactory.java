...
public class FastestDriverFactory {
     ...
     * parameters passed
     *
     * @param executionPlatform The {@link MobileExecutionPlatform} to be used for the test
     *                          execution
     * @param deviceName        The device name to be used for the test execution
     * @param host              The URL of the Mobile Min Cloud to be used for the test
     *                          execution
     * @param mobileVersion     The Mobile device version to be used for the test execution
