...
public class PerfectoLabUtils {
    ...
    private static final Logger logger = LogManager
            .getLogger(PerfectoLabUtils.class);
     ...
     */
    public static void downloadAttachment(RemoteWebDriver driver, String type,
        ...
        try {
            ...
            while (!done) {
                ...
                String attachment = (String) driver.executeScript(command,
                        params);
                ...
                if (attachment == null) {
                    ...
                    byte[] bytes = OutputType.BYTES
                            .convertFromBase64Png(attachment);
                    output.write(bytes);
                    output.close();
                    index++;
                }
    ...
    public static void uploadMedia(String host, String user, String password,
                                   String path, String repositoryKey) throws IOException {
    ...
    public static void uploadMedia(String host, String user, String password,
        ...
        if (content != null) {
            ...
            String urlStr = HTTPS + host + MEDIA_REPOSITORY + repositoryKey
                    + "?" + UPLOAD_OPERATION + "&user=" + encodedUser
    ...
    // */
    // public static void setExecutionIdCapability(DesiredCapabilities
    ...
    private static void handleError(HttpURLConnection connection)
            throws IOException {
    ...
    private static byte[] readFile(File path) throws
            IOException {
    ...
    private static byte[] readURL(URL url) throws IOException {
        ...
        if (stream == null) {
            throw new RuntimeException("Failed to get content from url " + url
                    + " - no response stream");
        }
