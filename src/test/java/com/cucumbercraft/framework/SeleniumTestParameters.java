...
public class SeleniumTestParameters {
     ...
     * executed
     *
     * @param executionPlatform The {@link MobileExecutionPlatform} for the test being
     *                          executed
     */
     ...
     *
     * @param toolName The {@link ToolName} for the test being executed
     */
     ...
     * be executed
     *
     * @param version The OS Version of device Version on which the test is to be
     *                executed
     */
    ...
    /**
     * @param deviceName The name of the mobile device on which the test is to be
     *                   executed
     */
    ...
    /**
     * @param manufacturer The name of the manufacturer Name on which the test is to be
     *                     executed
     */
    ...
    /**
     * @param modelName The name of the modelName on which the test is to be executed
     */
     ...
     *
     * @param version The See Test Port on which the test is to be executed
     */
     ...
     *
     * @param platformVersion The Platform Version on which the test is to be executed
     */
